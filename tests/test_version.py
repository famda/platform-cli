...
def test_version_format():
    ...
    Valid formats:
    - Semantic version: "0.0.1", "1.2.3"
    - Pre-release: "1.2.3.dev1", "1.2.3.rc1", "1.2.3.a1", "1.2.3.b1"
    - With git commit: "1.2.3.dev1+g90dfe88", "1.2.3.dev1+g90dfe88.d20260103"
    - Fallback: "unknown" if metadata is not available
    """
    # Version pattern components:
    # - \d+\.\d+\.\d+ : semantic version (major.minor.patch)
