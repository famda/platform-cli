...
# Usage: irm https://raw.githubusercontent.com/famda/platform-cli/main/docs/install-pr.ps1 | iex
# Then run: Install-SemanticsPR -PRNumber 123

function Install-SemanticsPR {
    param(
    ...
    function Write-Err { param($msg) Write-Host "error: " -ForegroundColor Red -NoNewline; Write-Host $msg; return }
...
# Export the function
Export-ModuleMember -Function Install-SemanticsPR -ErrorAction SilentlyContinue

Write-Host "Semantics PR Installer loaded." -ForegroundColor Green
Write-Host "Usage: Install-SemanticsPR -PRNumber <number> [-Variant <full|audio|video|document>]" -ForegroundColor Cyan
Write-Host ""
Write-Host "Example:" -ForegroundColor Yellow
Write-Host "  Install-SemanticsPR -PRNumber 42"
Write-Host "  Install-SemanticsPR -PRNumber 42 -Variant audio"
